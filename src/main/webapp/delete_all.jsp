    ...
    <%
        if (request.getAttribute("answer") != null) {
            out.println("<div class=\"w3-panel w3-green w3-display-container w3-card-4 w3-round\">\n" +
                    ...
                    "   class=\"w3-button w3-margin-right w3-display-right w3-round-large w3-hover-green w3-border w3-border-green w3-hover-white\">×</span>\n" +
                    "   <h5>All data has been deleted!</h5>\n" +
                    "</div>");
        }
    %>
    <div class="w3-card-4">
        ...
        <form method="post" class="w3-selection w3-centered w3-black w3-padding">
            <label>Type "yes" to delete all data:
                <input type="text" name="name" class="w3-input w3-animate-input w3-border-dark-gray w3-round-large" style="width: 30%"><br />
            </label>
